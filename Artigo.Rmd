...
# fit neural network
set.seed(2)
NN = neuralnet(valor ~ area_total + quartos + suites + garagens + dist_b_mar + padrao, trainNN, 
...
for(i in seq(0.2, 0.9, 0.1)){
  xval.out <- xvalPoly(data, maxDeg = 2, maxInteractDeg = 2, use = "lm", 
                       trnProp = i, pcaMethod = FALSE)
