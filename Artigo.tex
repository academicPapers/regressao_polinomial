...
\NormalTok{predict_testNN =}\StringTok{ }\NormalTok{(predict_testNN}\OperatorTok{$}\NormalTok{net.result }\OperatorTok{*}\StringTok{ }\NormalTok{(}\KeywordTok{max}\NormalTok{(data}\OperatorTok{$}\NormalTok{valor) }\OperatorTok{-}\StringTok{ }
\StringTok{                                                 }\KeywordTok{min}\NormalTok{(data}\OperatorTok{$}\NormalTok{valor))) }\OperatorTok{+}\StringTok{ }
